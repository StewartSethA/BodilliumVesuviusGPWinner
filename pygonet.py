...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True,
                 final_endpoint='Logits', name='inception_i3d', in_channels=3, dropout_keep_prob=0.5,forward_features=True,non_local=False,complexity=16,down=64):
        ...
        end_point = 'Logits'
        self.avg_pool = nn.AvgPool3d(kernel_size=[2, 7, 7], # Avg Pool across 2x channels, 7x spatially. Maybe too aggressive pooling here...
        ...
        self.logits = Unit3D(in_channels=c*24+c*24+c*8+c*8, output_channels=self._num_classes,
                             ...
                             use_bias=True,
                             name='logits')
        self.final_pool=self.avgpool = nn.AdaptiveMaxPool3d((1, 1, 1)) # THIS will bottleneck all of the predictions down to a single point anyway, so I don't have to worry about downsampling rate! Handy!
        self.complexity = c
        self.build()
